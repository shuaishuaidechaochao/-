...
import LocalDR from '备份/src/DRUtils/LocalDR.js'; //export default LocalDR //console.log(LocalDR.get("admin"))
...
<template>
  <div class="header">
    ...
    <div class="info">
      <div class="admin">
        <div class="name">
          <span>文超</span> <el-icon><Bell /></el-icon>
        </div>
